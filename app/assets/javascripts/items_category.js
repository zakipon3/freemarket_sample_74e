$(function(){
  ...
  if(request.indexOf("new") != -1 || request.indexOf("edit") != -1){
    $.ajax({
      ...
      $("#category-select").append(`<select class="exhibit__wrapper__itemdetail__selectbox select-parent" name="item[category_id]" id="product_category_id"><option value="">選択してください</option></select>`);
